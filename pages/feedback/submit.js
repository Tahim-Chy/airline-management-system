...
export default function SubmitFeedbackPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.ok) {
      ...
      setForm({ name: '', email: '', booking_id: '', category: 'Complaint', message: '' });
    } else {
    ...
    <div className="container mt-4" style={{ maxWidth: '500px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input className="form-control" value={form.booking_id} onChange={(e) => setForm({ ...form, booking_id: e.target.value })} />
        </div>
        <div className="mb-3">
