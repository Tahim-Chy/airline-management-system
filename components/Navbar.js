...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className={`w-100 flex-lg-row align-items-lg-center justify-content-lg-between ${mobileOpen ? 'd-flex' : 'd-none'} d-lg-flex mt-3 mt-lg-0 flex-column`}>
        <div className="navbar-nav flex-lg-row flex-column flex-wrap gap-1 gap-lg-1 align-items-lg-center ms-lg-3">
          ...
          <div className="position-relative">
            <button
              type="button"
              className="btn btn-sm btn-outline-light d-flex align-items-center gap-1 my-1 my-lg-0"
            ...
            {servicesOpen && (
              ...
              >
                ...
                <Link className="dropdown-item d-flex align-items-center gap-2 rounded-2 p-2" href="/book/cancel">
                  <i className="bi bi-x-circle text-navy" /> Cancel a Booking
                </Link>
