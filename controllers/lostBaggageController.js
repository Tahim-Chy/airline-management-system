...
export async function list(req, res) { try { res.status(200).json(await getAllReports()); } catch (error) { console.error(error); res.status(500).json({ error: 'Failed to fetch reports' }); } }
